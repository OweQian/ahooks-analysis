import {PaginationOptions, PaginationResult} from "@/hooks/usePagination/type";
...
export type Antd3ValidateFields = (fieldNames: string[], callback: (errors, values: Record<string, any>) => void,) => void;
